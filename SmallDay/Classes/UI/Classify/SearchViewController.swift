...
class SearchViewController: UIViewController, SearchViewDelegate {
    ...
    private var hotSearchs: [String] = ["诸葛烤鱼", "锅得缸", "那家小馆", "重庆森林", "免费试吃", "密室逃脱"]
    ...
    private var tableView: UITableView = {
        ...
        tableView.registerNib(UINib(nibName: "nearCell", bundle: nil), forCellReuseIdentifier: SD_DetailCell_Identifier)
        return tableView
        }()
